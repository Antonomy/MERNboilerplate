    ...
    <>
      {
                fruits && fruits.length
                  ...
                  : <h1>No Fruits Yet Add One Below</h1>
            }
      {'Name '}<input value={newFruit.name} onChange={handleChange} name='name' /><br />
      {'Color '}<input value={newFruit.color} onChange={handleChange} name='color' /><br />
      {'Ready To Eat '}<input type='checkbox' checked={newFruit.readyToEat} onChange={(evt) => setNewFruit({ ...newFruit, readyToEat: evt.target.checked })} /><br />
